...
export default function BookingList() {
  ...
  return (
    <div className="flex flex-col space-y-[24px] px-[32px] py-[32px]">
      {bookItems.map((item) => (
        <div className="flex flex-row justify-between bg-lime-100 px-[16px] py-[16px] w-full border-[2px]  border-lime-950 rounded-[24px]">
          <div
            className="flex flex-col space-y-[8px] text-lime-900"
            key={item.id}
          >
            <div className="text-[16px] flex flex-row items-center space-x-[8px]">
              <div>{item.name}</div>
